    ...
    var body: some View {
        NavigationView{
            VStack {
                ...
                Text("You must calculate before showing answer")
                    .font(.custom("Georgia", size: 10, relativeTo: .headline))
                    .multilineTextAlignment(.center)
        ...
        .padding()
        .alert("enter numbers pls (no fractions btw)", isPresented: $showAlert) {
